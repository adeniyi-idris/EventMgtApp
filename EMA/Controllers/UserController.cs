...
namespace EMA.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(DataContext db, UserManager<AppUser> userManager)
        {
            _db = db;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ManageClaims(UserClaimViewModel userClaimsViewModel)
        {
